...
(function (window) {
    ...
    /*for (var k = 0; k < 4; k++) {
        ...
        jsonLoader2.load("/static/files/glendale_2.js", function (data) {


            var material = new cfMaterial.material('lambert', {image: 'http://localhost:8004/static/images/fab-sofa.jpg', color: new THREE.Color('rgb(17,70,130)'), anisotropy: 30, repeatU: 10, repeatV: 10});
